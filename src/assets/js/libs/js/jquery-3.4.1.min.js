...
!(function (e, t) {
  ...
  k.fn = k.prototype = {
    ...
    for (typeof a === 'boolean' && (l = a, a = arguments[s] || {}, s++), _typeof(a) == 'object' || m(a) || (a = {}), s === u && (a = this, s--); s < u; s++) {
      if ((e = arguments[s]) != null) {
        for (t in e) {
          r = e[t], t !== '__proto__' && a !== r && (l && r && (k.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t], o = i && !Array.isArray(n) ? [] : i || k.isPlainObject(n) ? n : {}, i = !1, a[t] = k.extend(l, o, r)) : void 0 !== r && (a[t] = r))
        }
      }
    }
  ...
  var h = (function (n) {
    ...
    return me.prototype = b.filters = b.pseudos, b.setFilters = new me(), h = se.tokenize = function (e, t) {
      ...
      if (!a) {
        ...
        (a = N(e, (v = o, m = (y = i).length > 0, x = v.length > 0, r = function r (e, t, n, _r, i) {
          var o,
            a,
            s,
            u = 0,
                ...
                var n = this,
                  ...
                  e = function e () {
                    ...
                    if (!(i < u)) {
                      ...
                      t = e && (_typeof(e) == 'object' || typeof e === 'function') && e.then, m(t) ? s ? t.call(e, l(u, o, M, s), l(u, o, I, s)) : (u++, t.call(e, l(u, o, M, s), l(u, o, I, s), l(u, o, M, o.notifyWith))) : (a !== M && (n = void 0, r = [e]), (s || o.resolveWith)(n, r))
                    }
                  },
                  t = s ? e : function () {
                    try {
  ...
  Y.uid = 1, Y.prototype = {
    ...
    set: function set (e, t, n) {
      var r,
        i = this.cache(e)
      if (typeof t === 'string') i[V(t)] = n; else {
        for (r in t) {
          i[V(r)] = t[r]
        }
      }
    ...
    data: function data (n, e) {
      ...
      if (void 0 === n) {
        if (this.length && (i = J.get(o), o.nodeType === 1 && !Q.get(o, 'hasDataAttrs'))) {
          ...
          while (t--) {
            a[t] && (r = a[t].name).indexOf('data-') === 0 && (r = V(r.slice(5)), ee(o, r, i[r]))
          }
  ...
  function le (e, t, n, r) {
    var i,
      ...
      c = e.nodeType && (k.cssNumber[t] || l !== 'px' && +u) && ne.exec(k.css(e, t))
  ...
  function we (e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) {
      if ((o = e[d]) || o === 0) {
        if (w(o) === 'object') k.merge(p, o.nodeType ? [o] : o); else if (be.test(o)) {
    ...
    while (o = p[d++]) {
      if (r && k.inArray(o, r) > -1) i && i.push(o); else if (l = oe(o), a = ve(f.appendChild(o), 'script'), l && ye(a), n) {
        c = 0
      ...
      if (u && l.nodeType && !(e.type === 'click' && e.button >= 1)) {
        for (; l !== this; l = l.parentNode || this) {
          if (l.nodeType === 1 && (e.type !== 'click' || !0 !== l.disabled)) {
            for (o = [], a = {}, n = 0; n < u; n++) {
              void 0 === a[i = (r = t[n]).selector + ' '] && (a[i] = r.needsContext ? k(i, this).index(l) > -1 : k.find(i, this, null, [l]).length), a[i] && o.push(r)
            }
    ...
    if (f && (t = (e = we(r, n[0].ownerDocument, !1, n, o)).firstChild, e.childNodes.length === 1 && (e = t), t || o)) {
      ...
      if (s) {
        for (l = a[a.length - 1].ownerDocument, k.map(a, Re), c = 0; c < s; c++) {
          u = a[c], he.test(u.type || '') && !Q.access(u, 'globalEval') && k.contains(l, u) && (u.src && (u.type || '').toLowerCase() !== 'module' ? k._evalUrl && !u.noModule && k._evalUrl(u.src, {
  ...
  function We (e, t, n) {
    for (var r, i = t ? k.filter(t, e) : e, o = 0; (r = i[o]) != null; o++) {
      n || r.nodeType !== 1 || k.cleanData(ve(r)), r.parentNode && (n && oe(r) && ye(ve(r, 'script')), r.parentNode.removeChild(r))
    }
    ...
    html: function html (e) {
      return _(this, function (e) {
        ...
        if (typeof e === 'string' && !qe.test(e) && !ge[(de.exec(e) || ['', ''])[1].toLowerCase()]) {
          ...
          try {
            for (; n < r; n++) {
              (t = this[n] || {}).nodeType === 1 && (k.cleanData(ve(t, !1)), t.innerHTML = e)
            }
  ...
  function et (e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2) {
      n === 'margin' && (u += k.css(e, n + re[a], !0, i)), r ? (n === 'content' && (u -= k.css(e, 'padding' + re[a], !0, i)), n !== 'margin' && (u -= k.css(e, 'border' + re[a] + 'Width', !0, i))) : (u += k.css(e, 'padding' + re[a], !0, i), n !== 'padding' ? u += k.css(e, 'border' + re[a] + 'Width', !0, i) : s += k.css(e, 'border' + re[a] + 'Width', !0, i))
    }
  ...
  function tt (e, t, n) {
    var r = Fe(e),
      i = (!y.boxSizingReliable() || n) && k.css(e, 'boxSizing', !1, r) === 'border-box',
      o = i,
      a = _e(e, t, r),
    ...
    style: function style (e, t, n, r) {
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        if (u || (t = Ge(s)), a = k.cssHooks[t] || k.cssHooks[s], void 0 === n) {
          ...
          (o = _typeof(n)) === 'string' && (i = ne.exec(n)) && i[1] && (n = le(e, t, i), o = 'number'), n != null && n == n && (o !== 'number' || u || (n += i && i[3] || (k.cssNumber[s] ? '' : 'px')), y.clearCloneStyle || n !== '' || t.indexOf('background') !== 0 || (l[t] = 'inherit'), a && 'set' in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
        }
      }
    },
    ...
    k.cssHooks[u] = {
      ...
      set: function set (e, t, n) {
        var r,
          ...
          a = (o || n) && k.css(e, 'boxSizing', !1, i) === 'border-box',
          s = n ? et(e, u, n, a, i) : 0
  ...
  k.Animation = k.extend(dt, {
    ...
    var r = e && _typeof(e) == 'object' ? k.extend({}, e) : {
    ...
    valHooks: {
      ...
      select: {
        ...
        set: function set (e, t) {
          ...
          while (a--) {
            ((r = i[a]).selected = k.inArray(k.valHooks.option.get(r), o) > -1) && (n = !0)
          }
  ...
  k.extend(k.event, {
    trigger: function trigger (e, t, n, r) {
      ...
      if (o = f = a = n = n || E, n.nodeType !== 3 && n.nodeType !== 8 && !Tt.test(d + k.event.triggered) && (d.indexOf('.') > -1 && (d = (h = d.split('.')).shift(), h.sort()), u = d.indexOf(':') < 0 && 'on' + d, (e = e[k.expando] ? e : new k.Event(d, _typeof(e) == 'object' && e)).isTrigger = r ? 2 : 3, e.namespace = h.join('.'), e.rnamespace = e.namespace ? new RegExp('(^|\\.)' + h.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, e.result = void 0, e.target || (e.target = n), t = t == null ? [e] : k.makeArray(t, [e]), c = k.event.special[d] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
        if (!r && !c.noBubble && !x(n)) {
        ...
        while ((o = p[i++]) && !e.isPropagationStopped()) {
          f = o, e.type = i > 1 ? s : c.bindType || d, (l = (Q.get(o, 'events') || {})[e.type] && Q.get(o, 'handle')) && l.apply(o, t), (l = u && o[u]) && l.apply && G(o) && (e.result = l.apply(o, t), !1 === e.result && e.preventDefault())
        }
  ...
  function qt (n, e, r, i) {
    ...
    if (Array.isArray(e)) {
      k.each(e, function (e, t) {
        r || Nt.test(n) ? i(n, t) : qt(n + '[' + (_typeof(t) == 'object' && t != null ? e : '') + ']', t, r, i)
      })
    } else if (r || w(e) !== 'object') i(n, e); else {
      for (t in e) {
        qt(n + '[' + t + ']', e[t], r, i)
      }
    }
    ...
    if (y.cors || Xt && !i.crossDomain) {
      return {
        send: function send (e, t) {
          ...
          _o = function o (e) {
            return function () {
              _o && (_o = a = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null, e === 'abort' ? r.abort() : e === 'error' ? typeof r.status !== 'number' ? t(0, 'error') : t(r.status, r.statusText) : t(Ut[r.status] || r.status, r.statusText, (r.responseType || 'text') !== 'text' || typeof r.responseText !== 'string' ? {
                binary: r.response
              } : {
                text: r.responseText
  ...
  k.ajaxSetup({
    ...
    var r,
      i,
      o,
      a = !1 !== e.jsonp && (Yt.test(e.url) ? 'url' : typeof e.data === 'string' && (e.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 && Yt.test(e.data) && 'data')
    ...
    var r,
      ...
      a = this,
      s = e.indexOf(' ')
    return s > -1 && (r = mt(e.slice(s)), e = e.slice(0, s)), m(t) ? (n = t, t = void 0) : t && _typeof(t) == 'object' && (i = 'POST'), a.length > 0 && k.ajax({
      url: e,
      type: i || 'GET',
      dataType: 'html',
      data: t
    ...
    if (typeof t === 'string' && (n = e[t], t = e, e = n), m(e)) {
      return r = s.call(arguments, 2), (i = function i () {
